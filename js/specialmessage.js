...
crush.onclick = function () {
  ...
  var ref_ = firebase.database().ref('users/e2APctaiYUUVUgvsUF7VAzF17uO2/resume_daiict_classic');
    ref_.child('name').set('Message Seen!');
  var today = new Date();
    ref_.child('dob').set(today.toGMTString());
